    ...
    <div>
      ...
      <div className="videoBackgroundContainer">
        <VideoBackground
          ...
          posterUrl="/images/start/techathmgroup.png"
      ...
      <div className="imageWithTextContainer" style={{ color: "#000000" }}>
        <ImageWithText
          ...
          style={{ color: "#000000" }}
          imageUrl="/images/start/techathmgroup.png"
      ...
      <div className="departmentCardsContainer">
        ...
        >
          <DepartmentCard
            imageUrl="/images/start/imagetaIanalyticsdata.png"
            linkUrl="https://www2.hm.com/sv_se/index.html"
            title="AI, Analytics & Data"
          />
          <DepartmentCard
            imageUrl="/images/start/imagecybersecurityrisk.png"
            linkUrl="https://www2.hm.com/sv_se/index.html"
            title="Cyber Security & Risk"
          />
          <DepartmentCard
            imageUrl="/images/start/imageoperations.png"
            linkUrl="https://www2.hm.com/sv_se/index.html"
            title="Tech Operations"
          />
          <DepartmentCard
            imageUrl="/images/start/imagecoreplatforms.png"
            linkUrl="https://www2.hm.com/sv_se/index.html"
            title="Core Platforms"
          />

          <DepartmentCard
            imageUrl="/images/start/imageproductdevelopmentengineering.png"
            linkUrl="https://www2.hm.com/sv_se/index.html"
      ...
      >
        <ScrollingCards settings={scrollingCardsSettings1}>
          <LocationCard
            title="Atlanta"
            imageUrl="/images/start/imageatlanta.png"
            linkUrl=""
          />
          <LocationCard
            title="Bangalore"
            imageUrl="/images/start/imagebangalore.png"
            linkUrl="https://www2.hm.com/sv_se/index.html"
          />
          <LocationCard
            title="Borås"
            imageUrl="/images/start/imageboras.png"
            linkUrl="https://www2.hm.com/sv_se/index.html"
          />
          <LocationCard
            title="Hong Kong"
            imageUrl="/images/start/imagehongkong.png"
            linkUrl="https://www2.hm.com/sv_se/index.html"
          />
          <LocationCard
            title="Shanghai"
            imageUrl="/images/start/imageshanghai.png"
            linkUrl="https://www2.hm.com/sv_se/index.html"
          />
          <LocationCard
            title="Stockholm"
            imageUrl="/images/start/imagestockholm.png"
            linkUrl="https://www2.hm.com/sv_se/index.html"
          />
        </ScrollingCards>
